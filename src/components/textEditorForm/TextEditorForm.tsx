    ...
    <div className='form-preview-container'>
      ...
      <div className='form-container'>
        <form onSubmit={handleSubmit} className='editor-form'>
          ...
          <input type='text' id='pageTitle' name='pageTitle' placeholder='Enter page title' maxLength={100} onChange={handleTitleChange} />
          ...
          <div className='toolbar'>
            ...
            <button type='button' onClick={() => formatText('unlink')}>
              Unlink
            </button>
          </div>
      ...
      <div className='preview-container'>
        ...
        <div className='preview-description' dangerouslySetInnerHTML={{ __html: pageDescription }} />
      </div>
    </div>
  );
};
