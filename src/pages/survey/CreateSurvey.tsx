    ...
    if (surveyId) {
      dispatch(
        updateSurveyThunk({
          surveyId: surveyId || '',
          surveyName: lavel,
          surveyDescription: surveyForm.surveyDescription,
        })
      );
    }
    setIsTitle((prev) => !prev);
              ...
              <section className='containerCreateSurvey'>
                ...
                <section className='surveyPage'>
                  ...
                  <div className='surveyPage'>
                    {isSurveyDescription ? (
                      <NewTextEditor label={surveyForm.surveyDescription} onSave={onSavePageTitle} onCancel={onCanclePageTitle} />
                    ) : (
                      <div className='surveyTitle'>
                        <h1>
                      ...
                      <div className='questionAndDropdown'>
                        ...
                        <div className='question-text-container'>
                          <label className='question-text-label'>
                            Question Text:
                            <input type='text' value={questionName} onChange={handleQuestionTextChange} className='question-text-input' />
                          </label>
                        </div>
                      </div>
