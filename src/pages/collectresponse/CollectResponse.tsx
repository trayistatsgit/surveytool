...
const CollectResponse :React.FC = ()=>{
  ...
  const rows = [
    { nickname: 'Target Audience 1', response: 0, status: 'DRAFT', datemodify: '10/4/2024' },
  ];
    return(
         ...
         <Button className='add-new-collector' label='ADD NEW COLLECTOR' />
          ...
          <div className='survey-total'>
            <div className='total-response-container'> 
                ...
                <Typography className='manage-notification' label='Manage Notification' fontSize='fontSize12' fontWeightstest={200} fontWeight='regular' />
                    
                    </div> 
            </div>
            <div className='footer'>
            <Typography  label='Boost your survey response rate with a custom' fontSize='fontSize14' fontWeightstest={200} fontWeight='regular' />
            </div>
